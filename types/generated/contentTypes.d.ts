...
export interface ApiHomePortfolioHomePortfolio extends Struct.SingleTypeSchema {
  collectionName: 'home_portfolios';
  info: {
    displayName: 'Home Portfolio';
    pluralName: 'home-portfolios';
    singularName: 'home-portfolio';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::home-portfolio.home-portfolio'
    >;
    publishedAt: Schema.Attribute.DateTime;
    sections: Schema.Attribute.DynamicZone<
      [
        'components.hero-minimalf',
...
export interface ApiInfoPortfolioInfoPortfolio extends Struct.SingleTypeSchema {
  collectionName: 'info_portfolios';
  info: {
    displayName: 'Info Portfolio';
    pluralName: 'info-portfolios';
    singularName: 'info-portfolio';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::info-portfolio.info-portfolio'
    >;
    publishedAt: Schema.Attribute.DateTime;
    sections: Schema.Attribute.DynamicZone<
...
export interface ApiLayoutLayout extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    floatingBtnMessage: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    floatingItems: Schema.Attribute.Component<
      'shared.nav-items-floating',
      true
    > &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
    ...
    fotterCopyrightTYear: Schema.Attribute.String &
      ...
      Schema.Attribute.DefaultTo<'2026 Manudev'>;
    fotterMessageRigth: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }> &
      Schema.Attribute.DefaultTo<'Web Develop'>;
    fotterTitleLeft: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    nav: Schema.Attribute.Component<'shared.nav', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    publishedAt: Schema.Attribute.DateTime;
    showContactItem: Schema.Attribute.Boolean &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    showFloatingBtn: Schema.Attribute.Boolean &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    showMessage: Schema.Attribute.Boolean &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    showShareItem: Schema.Attribute.Boolean &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiProjectPortfolioProjectPortfolio
  ...
  attributes: {
    ...
    imgPreview: Schema.Attribute.Media<'images' | 'files'> &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
    ...
    >;
    projectTag: Schema.Attribute.Enumeration<['code', 'wordpress']> &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
    ...
    sections: Schema.Attribute.DynamicZone<
      [
        ...
        'components.media-content-split',
        'components.project-text-media',
...
export interface ApiWebDevelopWebDevelop extends Struct.SingleTypeSchema {
  collectionName: 'web_develops';
  info: {
    displayName: 'Web Develop';
    pluralName: 'web-develops';
    singularName: 'web-develop';
  };
  options: {
    draftAndPublish: true;
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::web-develop.web-develop': ApiWebDevelopWebDevelop;
